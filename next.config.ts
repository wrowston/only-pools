...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    return [
      ...
      { source: "/terms", headers: publicHtmlCache },
      { source: "/privacy", headers: publicHtmlCache },
...
export default withSentryConfig(withMDX(nextConfig), {
  ...
  org: process.env.SENTRY_ORG ?? "inference-partners",

  project: process.env.SENTRY_PROJECT ?? "only-pools",

  // Source map upload — set SENTRY_AUTH_TOKEN in CI or .env.sentry-build-plugin
