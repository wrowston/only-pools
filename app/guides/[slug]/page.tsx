...
export default async function GuidePage({ params }: GuidePageProps) {
  ...
  const loader = guideContentLoaders[slug];
  if (!guide || !loader) notFound();
  ...
  return (
    <article className="px-5 py-10 sm:px-8 sm:py-14">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-12 rounded-[12px] border border-op-border bg-op-surface px-4 py-3 text-sm leading-6 text-op-secondary">Still looking for an answer? Check the <Link href="/guides/faq" className="font-medium text-op-selected-fg underline underline-offset-4">Frequently Asked Questions</Link>.</p>
